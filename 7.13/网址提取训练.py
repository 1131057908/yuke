...
while record_position<len(string):
    ...
    if start_mark==-1:
        print('没有找到')
        break
        #因为使用find找到的是start_mark的'h;这个字母的索引值,还有end_mark的?索引值
