...
def add_or_update_phone_info():
    ...
    if select_number==1:
        ...
        # 调用select_all_phone函数，参数设置为T。将所有的手机详细信息全部打印出来，用户再根据对应的编号选择要对那个手机进行修改操作。
